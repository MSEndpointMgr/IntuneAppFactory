...
Try {
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		#Uninstall any previous versions of application by calling the command from Uninstall-string
		$AppList = Get-InstalledApplication -Name 'Notepad++'
        ...
        ## Cleanup Notepad ++ Program Files Directory (If Present)
		$InstallPath = Join-Path -Path $env:ProgramFiles -ChildPath "Notepad++"
